		...
		<input type="hidden" id="specId" name="id" value="${spec.id }">
		 ...
		 <div class="form-group row">
		 	...
		 	<table id="table">
		 		...
		 		<c:forEach items="${spec.options }" var="options" varStatus="index">
		 		<tr>
		 			<td><input name="options[${index.index }].optionName" value="${options.optionName }"></td>
		 			<td><input type="number" name="options[${index.index }].orders" value="${options.orders }"></td>
...
var i=parseInt("${sepc.options.size()}");
function addLine(){
	$("#table").append(`<tr>
